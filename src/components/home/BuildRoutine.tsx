...
const routineSteps = {
  morning: [
    { step: 1, name: 'Gentle Cleanser', description: 'Start with a clean canvas', price: '$34.99' },
    { step: 2, name: 'Vitamin C Serum', description: 'Brighten and protect', price: '$89.99' },
    { step: 3, name: 'Daily Moisturizer', description: 'Hydrate with SPF protection', price: '$48.99' },
  ],
  evening: [
    { step: 1, name: 'Gentle Cleanser', description: 'Remove the day away', price: '$34.99' },
    { step: 2, name: 'Balancing Toner', description: 'Refresh and balance', price: '$42.99' },
    { step: 3, name: 'Nourishing Face Oil', description: 'Deep overnight repair', price: '$65.99' },
    { step: 4, name: 'Night Cream', description: 'Regenerate while you sleep', price: '$75.99' },
  ]
};
